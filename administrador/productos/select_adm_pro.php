    ...
    <header id="caja1-rol-titulo">
      ...
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          ...
          <div class="row">
            ...
            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
              <div class="mover d-flex justify-content-center">
                <?php if($_SESSION['rol']==1){ ?>
                <form class="mover d-flex justify-content-end" name="insert" method="post" action="tipo/select_adm_tipo.php">
                  <button class="boton-insertar2-tipo-producto" type="submit" name="TIPO DE PRODUCTOS" value="TIPO DE PRODUCTOS">
                    TIPO DE PRODUCTOS <i class="fas fa-paste" ></i>
                  </button>
                </form>
          ...
          <div>
            <form method="post" action="select_adm_pro.php">
              <div class="table-responsive">
                <table>
                  <tr>
                    <td class="th1"><b>N°</b></td>
                    <td class="th1"><b>COD</b></td>
                    <td class="th1"><b>NOMBRE</b></td>
                    <td class="th1"><b>TIPO</b></td>
                    <td class="th1"><b>CARACTERISTICAS</b></td>
                    <td class="th1"><b>MEDIDA</b></td>
                    <td class="th1"><b>ALTURA</b></td>
                    <td class="th1"><b>GARANTIA</b></td>
                    <td class="th1"><b>EXISTENCIAS</b></td>
                    <td class="th1"><b>VALOR UNITARIO</b></td>
                    <td class="th1"><b>IMAGEN</b></td>
                    <?php if($_SESSION['rol']==1){ ?>
                  ...
                  $sql_registe=mysqli_query($con,"SELECT COUNT(*) AS cantidad FROM producto");
                    ...
                    $consulta="SELECT * FROM producto,tipo WHERE tipo.IdTipo=producto.IdTipo ORDER BY producto.IdProducto DESC LIMIT $desde,$por_pagina";
                    $ejecutar=mysqli_query($con,$consulta);
                    $i=0;
                    while ($fila=mysqli_fetch_array($ejecutar)) {

                      if ($fila['Ruta_Imagen']) {
                        $foto='../../img/imgproductos/'.$fila['Ruta_Imagen'];
                      }else if($fila['']='Ruta_Imagen'){
                        $foto='../../img/imgproductos/img_producto.png';
                      }
                  ...
                  <tr>
                    ...
                    <td class="img_producto"><img src="<?php echo $foto; ?>"></td>
                    <?php if($_SESSION['rol']==1){ ?>
                    <td><a class="btn-actualizar" href="act_adm_pro.php?actualizar=<?php echo $idproducto; ?>">ACTUALIZAR</a></td>
                    <?php } ?>
                    <?php if($_SESSION['rol']==1){ ?>
                    <td><a href="select_adm_pro.php?eliminar=<?php echo $idproducto; ?>"><i class='far fa-trash-alt' style='font-size:24px;color:black;' onclick="return ComfirmDelete()" ></i></a></td>
                    <?php } ?>
                  </tr>
                  <?php
                    }
              ...
              <?php
                if (isset($_GET['eliminar'])) {
                  ...
                  $eliminar="DELETE FROM producto WHERE IdProducto='$borrar_id'";
