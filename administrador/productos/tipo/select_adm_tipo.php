<?php
  ...
  if (!empty($_POST)) {
    if (empty($_POST['txtNombre'])) {
      ...
      $sql=mysqli_query($con,"INSERT INTO tipo(NombreT) VALUES('$nombre')");
      if ($sql) {
        echo "<script>alert('Registro Insertado')</script>";
        echo "<script>window.open('select_adm_tipo.php','_self')</script>";
      }else{
      ...
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
            <h1 class="h2">TIPO DE PRODUCTOS</h1>
              ...
              <div class="table-responsive">
                <table>
                  ...
                  <tr>
                    ...
                    <td><a class="btn-actualizar" href="#actualizar<?php echo $idtipo; ?>" data-toggle="modal">ACTUALIZAR</a></td>

                    <td><a href="select_adm_tipo.php?eliminar=<?php echo $idtipo; ?>"><i class='far fa-trash-alt' style='font-size:24px;color:black;' onclick="return ComfirmDelete()" ></i></a></td>
                  </tr>



          <!-- Modal actualizar -->
          <div id="actualizar<?php echo $idtipo; ?>"class="modal fade" data-target="#actualizar<?php echo $idtipo; ?>" role="dialog">
            <div class="modal-dialog modal-md">
              <div class="modal-content">
                <div class="modal-header d-flex justify-content-between">
                  <h3 class="modal-title text-center">Actualizar tipo producto</h3>
                  ...
                  <div class="container-fluid">
                      ...
                      <div class="row py-2">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                          <input type="hidden" name="txtid" value="<?php echo $idtipo; ?>">
                        </div>
              ...
              <?php
                if (isset($_POST['actualizar'])) {
                  ...
                  if (empty($_POST['txtNombreT'])) {
                    ...
                    $actualizar="UPDATE tipo SET NombreT='$nombre_a' WHERE IdTipo=$idp_a ";
      ...
      <!--INICIO MODALES-->
        ...
        <div id="new_tipo_pro" class="modal fade" role="dialog">
          ...
          <div class="modal-dialog modal-md">
            ...
            <div class="modal-content">
                <div class="modal-header d-flex justify-content-between">
                  <h3 class="modal-title text-center titulo_modal">INSERTAR TIPO DE PRODUCTO</h3>
                  <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                  ...
                  <form name="form" method="post" action="">
                    <div class="caja-actualizar">
                      ...
                      <div class="row py-2">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                          <label for="inputName" class="sr-only">Nombre</label>
                          <input type="text" id="inputName" class="form-control" placeholder="Nuevo Tipo Producto" name="txtNombre" required>
                        </div>
