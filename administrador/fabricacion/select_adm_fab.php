<?php
  ...
  if (isset($_POST['nuevo'])) {
    $alert='';
    if (empty($_POST['selectProducto']) || empty($_POST['txtFecha']) || empty($_POST['txtCantidad'])) {
      ...
      $sql1=mysqli_query($con,"INSERT INTO fabricacion(IdPro, Fecha, Cantidad) VALUES('$producto','$fecha','$cantidad')");


      if (isset($_POST['nuevo'])) {
        $idproducto=$_POST['selectProducto'];
        $cantidad=$_POST['txtCantidad'];

        $actualizar="UPDATE producto SET Existencias=Existencias+$cantidad WHERE IdProducto=$idproducto ";
      ...
      if ($sql1 && $ejecutar) {
        ...
        echo "<script>alert('El Producto $idproducto ha sido Actualizado')</script>";
        echo "<script>window.open('select_adm_fab.php','_self')</script>";
      }else{
...
<body class="foto-ini-rol">
    ...
    <header id="caja1-rol-titulo">
        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="../fabricacion/select_adm_fab.php">
          ...
          <div class="row">
            ...
            <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
              <div class="mover d-flex justify-content-center">
                <button class="boton3-ini-nuevo" data-toggle="modal" data-target="#new_fabricaciones"> NUEVO <i class="fas fa-plus"></i> </button>
              </div>
            </div>
          </div>
            ...
            <form method="post" action="">
              <div class="table-responsive">
                <table>
                  ...
                  <?php
                  $sql_registe=mysqli_query($con,"SELECT COUNT(*) AS cantidad FROM fabricacion");
                    ...
                    $consulta="SELECT * FROM fabricacion,producto WHERE producto.IdProducto=fabricacion.IdPro ORDER BY fabricacion.IdFabricacion DESC LIMIT $desde,$por_pagina";
                    $ejecutar=mysqli_query($con,$consulta);
                    $i=0;
                    while ($fila=mysqli_fetch_array($ejecutar)) {
                      $idfabricacion=$fila['IdFabricacion'];
                      $producto=$fila['IdProducto'];
                      $idproducto=$fila['NombrePro'];
                      $fecha=$fila['Fecha'];
                      $medida=$fila['Medida'];
                  ...
                  <tr>
                    <td><?php echo $in; ?></td>
                    <td><?php echo $idproducto; ?> <b>de</b> <?php echo $medida; ?></td>
                    <td><?php echo $fecha; ?></td>
                    <td><?php echo $cantidad; ?></td>
                    <?php if($_SESSION['rol']==1){ ?>
                    <td><a href="select_adm_fab.php?eliminar=<?php echo $idfabricacion; ?>"><i class='far fa-trash-alt' style='font-size:24px;color:black;' onclick="return ComfirmDelete()" ></i></a></td>
                    <?php }?>
                  </tr>
              ...
              <?php
                if (isset($_GET['eliminar'])) {
                  ...
                  $consulta_eliminar="SELECT IdPro, Cantidad  FROM fabricacion WHERE IdFabricacion='$borrar_id'";
                  $ejecutar_eliminar=mysqli_query($con,$consulta_eliminar);
                  $fila_eliminar=mysqli_fetch_array($ejecutar_eliminar);

                  $idpro_eliminar=$fila_eliminar['IdPro'];
                  $cantidad_eliminar=$fila_eliminar['Cantidad'];

                  $actualizar="UPDATE producto SET Existencias=Existencias-$cantidad_eliminar WHERE IdProducto=$idpro_eliminar ";
                  $ejecutar_2=mysqli_query($con,$actualizar);



                  if (isset($_GET['eliminar'])) {
                    $borrar_id2=$_GET['eliminar'];

                    $eliminar="DELETE FROM fabricacion WHERE IdFabricacion='$borrar_id2'";
                    $ejecutar_1=mysqli_query($con,$eliminar);

                }


                  if ($ejecutar_1 && $ejecutar_2) {
                    echo "<script>alert('la fabricacion se ha sido eliminado')</script>";
      ...
      <!--INICIO MODALES-->
        ...
        <div id="new_fabricaciones" class="modal fade" role="dialog">

          <div class="modal-dialog modal-md">

            <div class="modal-content">
                <div class="modal-header d-flex justify-content-between">
                  <h3 class="modal-title text-center titulo_modal">INSERTAR FABRICACION</h3>
                    ...
                    <div class="caja-actualizar">
                      ...
                      <div class="row py-2">
                        ...
                        <div class="col-xs-12 col-sm-5 col-md-5 col-lg-5">
                          <p class="caja-actualizar-cli">producto: </p>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                          <select name="selectProducto" class="form-control">
                            <option value="0">Seleccione un producto</option>

                            <?php
                              $sql=mysqli_query($con,"select * from producto");
                              while ($res=mysqli_fetch_array($sql)) {
                                echo "<option value=".$res['IdProducto'].">".$res['NombrePro']." <b>de</b> ".$res['Medida']."</option>";
                              }
                            ?>
                      ...
                      <div class="row py-2">
                        ...
                        <div class="col-xs-12 col-sm-5 col-md-5 col-lg-5">
                          <p class="caja-actualizar-cli">Fecha de Fabricacion: </p>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                          <label for="inputFecha" class="sr-only">Fecha de Fabricacion</label>
                      ...
                      <div class="row py-2">
                        ...
                        <div class="col-xs-12 col-sm-5 col-md-5 col-lg-5">
                          <p class="caja-actualizar-cli">Cantidad Fabricada: </p>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                          <label for="inputCantidad" class="sr-only">Cantidad Fabricada</label>
                          <input type="number" id="inputCantidad" class="form-control" placeholder="Cantidad Fabricada" name="txtCantidad" required>
                        </div>
