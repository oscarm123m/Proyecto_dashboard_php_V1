            ...
            <form method="post" action="select_adm_pro.php">
              <div class="table-responsive">
                <table>
                  ...
                  <?php
                  $sql_registe=mysqli_query($con,"SELECT COUNT(*) AS cantidad FROM proveedor");
                    ...
                    $consulta="SELECT * FROM proveedor ORDER BY IdProveedor DESC LIMIT $desde,$por_pagina";
                  ...
                  <tr>
                    ...
                    <td><a href="select_adm_pro.php?eliminar=<?php echo $idproveedor; ?>"><i class='far fa-trash-alt' style='font-size:24px;color:black;' onclick="return ComfirmDelete()" ></i></a></td>
                    <?php }?>
                  </tr>
