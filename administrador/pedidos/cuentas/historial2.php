    ...
    <header id="caja1-rol-titulo">
      ...
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          ...
          $sql_consulta=mysqli_query($con,"SELECT cuentapendiente.Estado as estado, cuentapendiente.Fecha AS fecha, cuentapendiente.SaldoPagar AS saldopagar_p, cuentapendiente.ValorFacura AS factura, cuentapendiente.IdCuentaPendiente AS id, proveedor.IdProveedor AS idprovee, proveedor.Nombre AS nombre_p, proveedor.Nit AS nit, cuentapendiente.Descripcion as descripcion, cuentapendiente.SaldoPendiente AS saldo FROM proveedor, cuentapendiente WHERE proveedor.IdProveedor=cuentapendiente.IdProveedor AND (proveedor.Nombre LIKE '%$busqueda%' OR proveedor.Nit LIKE '%$busqueda%')");
          ...
          <div class="row">
            <div class="listado1 col-xs-12 col-sm-6 col-md-6 col-lg-6">
              HISTORIAL DE CUENTAS POR PAGADAS
            </div>
          ...
          <?php if($sql_result!=''){ ?>
              ...
              <div class="table-responsive">
                <table>
                  ...
                  <?php
                    $sql_registe=mysqli_query($con,"SELECT COUNT(*) AS cantidad FROM cuentapendiente, proveedor WHERE proveedor.IdProveedor=cuentapendiente.IdProveedor AND (proveedor.Nombre LIKE '%$busqueda%' OR proveedor.Nit LIKE '%$busqueda%')");
                    ...
                    //SELECT cuentapendiente.Estado as estado, cuentapendiente.Fecha AS fecha, cuentapendiente.SaldoPagar AS saldopagar_p, cuentapendiente.ValorFacura AS factura, cuentapendiente.IdCuentaPendiente AS id, proveedor.IdProveedor AS idprovee, proveedor.Nombre AS nombre_p, proveedor.Nit AS nit, cuentapendiente.Descripcion as descripcion, cuentapendiente.SaldoPendiente AS saldo FROM proveedor, cuentapendiente WHERE proveedor.IdProveedor=cuentapendiente.IdProveedor AND cuentapendiente.IdProveedor='$busqueda' ORDER BY cuentapendiente.IdCuentaPendiente DES

                    $consulta="SELECT cuentapendiente.Estado as estado, cuentapendiente.Fecha AS fecha, cuentapendiente.SaldoPagar AS saldopagar_p, cuentapendiente.ValorFacura AS factura, cuentapendiente.IdCuentaPendiente AS id, proveedor.IdProveedor AS idprovee, proveedor.Nombre AS nombre_p, proveedor.Nit AS nit, cuentapendiente.Descripcion as descripcion, cuentapendiente.SaldoPendiente AS saldo FROM proveedor, cuentapendiente WHERE proveedor.IdProveedor=cuentapendiente.IdProveedor AND (proveedor.Nombre LIKE '%$busqueda%' OR proveedor.Nit LIKE '%$busqueda%') ORDER BY cuentapendiente.IdCuentaPendiente DESC LIMIT $desde,$por_pagina";
                    ...
                    while ($fila=mysqli_fetch_array($ejecutar)) {
                      ...
                      $saldo_pago=$fila['saldopagar_p'];
                      $saldo_pend=$fila['saldo'];
                      $fac=$fila['factura'];
                      $fecha=$fila['fecha'];
                      $estado=$fila['estado'];
                      $i++;
                  ...
                  <tr>
                    ...
                    <td>$ <?php echo number_format($saldo_pago); ?></td>
                    <td>$ <?php echo number_format($saldo_pend); ?></td>
                    <td>$ <?php echo number_format($fac); ?></td>

                    <?php if($estado=='No se debe'){?>

                    <td><?php echo $estado; ?></td>

                    <?php }else if($estado=='Se debe'){?>
