    ...
    <header id="caja1-rol-titulo">
      ...
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          ...
          if ($busqueda=='0') {
            echo "<script>window.open('select_adm_ped.php','_self')</script>";
          }else if(empty($busqueda)){
            header("location: select_adm_ped.php");
          }
          ?>
          ...
          <div class="row">
            ...
            <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
              <form action="select_adm_ped_bus.php" method="get" class="form_search">
            ...
            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
              <div class="mover d-flex justify-content-center">
                ...
                <form class="mover d-flex justify-content-end" name="insert" method="post" action="cuentas/select_adm_cue.php">
                  <button class="boton-insertar2-tipo-producto" type="submit" name="DEUDORES" value="DEUDORES">CUENTAS POR PAGAR<i class="fa fa-list" aria-hidden="true"></i>
          ...
          <!--CONSULTA 4-->
              <div class="table-responsive">
                <table>
                  <tr>
                    <td class="th1">N°</td>
                    <td class="th1">Fecha</td>
                    <td class="th1">Proveedor</td>
                    <td class="th1">FAC_N°</td>
                    <td class="th1">Cantidad de articulos</td>
                    <td class="th1">Valor Total</td>
                    <td class="th1">VER</td>
                    <?php if($_SESSION['rol']==1){ ?>
                    <td class="th1">ELIMINAR</td>
                    <?php } ?>
                  </tr>

                  <?php
                    $sql_registe=mysqli_query($con,"SELECT COUNT(*) AS cantidad FROM pedido");
                    ...
                    $consulta="SELECT p.IdPedido AS Cod_Pedido, (SELECT pr.Nombre FROM proveedor pr WHERE pr.IdProveedor=p.IdProveedor) AS proveedor, (SELECT COUNT(*) FROM detallepedido dp WHERE dp.IdPedido=p.IdPedido) AS cantidad , p.Fecha AS fecha, p.ValorTotal AS valortotal,p.NoFac AS nofac FROM pedido p, proveedor WHERE proveedor.IdProveedor=p.IdProveedor AND (proveedor.Nombre LIKE '%$busqueda%' OR p.NoFac LIKE '%$busqueda%') ORDER BY p.IdPedido DESC LIMIT $desde,$por_pagina";
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <form action="ver.php" method="post">
                        <input type="hidden" name="id_pedido" value="<?php echo $Cod_Pedido; ?>">
                        <button class="btn_ver_fac">VER <i class="fa fa-search" aria-hidden="true"></i></button>
                      </form>

                    </td>
                    <?php if($_SESSION['rol']==1){ ?>
                    <td><a href="select_adm_ped.php?eliminar=<?php echo $Cod_Pedido; ?>"><i class='far fa-trash-alt' style='font-size:24px;color:black;' onclick="return ComfirmDelete()" ></i></a></td>
                    <?php } ?>
                  </tr>
              ...
              <?php
                if (isset($_GET['eliminar'])) {
                  ...
                  $eliminar_2="DELETE FROM detallepedido WHERE IdPedido='$borrar_id'";
                  $ejecutar_2=mysqli_query($con,$eliminar_2);
                  if ($ejecutar_2) {
                    $eliminar="DELETE FROM pedido WHERE IdPedido='$borrar_id'";
