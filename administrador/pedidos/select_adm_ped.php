              ...
              <div class="table-responsive">
                <table>
                  ...
                  <?php
                    ...
                    $consulta="SELECT p.IdPedido AS Cod_Pedido, (SELECT pr.Nombre FROM proveedor pr WHERE pr.IdProveedor=p.IdProveedor) AS proveedor, (SELECT COUNT(*) FROM detallepedido dp WHERE dp.IdPedido=p.IdPedido) AS cantidad , p.Fecha AS fecha, p.ValorTotal AS valortotal,p.NoFac AS nofac FROM pedido p ORDER BY p.IdPedido DESC LIMIT $desde,$por_pagina";
