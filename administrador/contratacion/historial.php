      ...
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
            <h1 class="h2">HISTORIAL NOMINA</h1>
          ...
          <div class="row">
            ...
            <div class="listado1 col-xs-12 col-sm-7 col-md-7 col-lg-7">
              <?php if(isset($_POST['fecha'])) {
                $busqueda1=$_POST['busqueda1'];
                $busqueda2=$_POST['busqueda2'];
                echo 'HISTORIAL NOMINA ENTRE <b>'.$busqueda1.'</b> Y <b>'.$busqueda2.'</b> ';
              } else{
                setlocale(LC_ALL,"es_ES");
                echo strftime("<div class='row'><div>HISTORIAL NOMINA MES DE </div><div style='text-transform: uppercase; font-weight: bold;'>%B</div></div>");
              }
              ?>
            </div>
          ...
          if(isset($_POST['fecha'])){
            $busqueda_1=$_POST['busqueda1'];
            $busqueda_2=$_POST['busqueda2'];
              ...
              <div class="table-responsive">
                <table>
                  ...
                  <?php
                    ...
                    $consulta="SELECT * FROM persona,contratacion,cargo WHERE persona.IdPersona=contratacion.IdPersona AND cargo.IdCargo=persona.IdCargo AND persona.IdCargo <> 3 AND contratacion.FechaPago BETWEEN '$busqueda_1' AND '$busqueda_2' ORDER BY contratacion.IdContratacion DESC";
                  ...
                  <tr>
                    <td colspan="5" style="text-align: right; font-weight: bold; font-size: 15px;">VALOR TOTAL</td>
                    <td style="font-weight: bold; font-size: 15px;">$<?php echo number_format($total_1); ?></td>
                  </tr>
              ...
              <div class="table-responsive">
                <table>
                  ...
                  <?php
                    ...
                    $consulta="SELECT * FROM persona,contratacion,cargo WHERE persona.IdPersona=contratacion.IdPersona AND cargo.IdCargo=persona.IdCargo AND persona.IdCargo <> 3 AND MONTH(contratacion.FechaPago)=MONTH(curdate()) ORDER BY contratacion.IdContratacion DESC";
                    $ejecutar=mysqli_query($con,$consulta);
                    $i=0;
                    $total=0;
                    while ($fila=mysqli_fetch_array($ejecutar)) {
                  ...
                  <tr>
                    <td colspan="5" style="text-align: right; font-weight: bold; font-size: 15px;">VALOR TOTAL</td>
                    <td style="font-weight: bold; font-size: 15px;">$ <?php echo number_format($total); ?></td>
                  </tr>
