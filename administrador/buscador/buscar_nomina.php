    ...
    <header id="caja1-rol-titulo">
      ...
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          ...
          if (empty($busqueda)) {
            header("location: ../contratacion/select_adm_con.php");
          }
          ?>
          ...
          <div class="row">
            ...
            <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
              <div class="mover d-flex justify-content-center">
                ...
                <form class="mover d-flex justify-content-end" name="insert" method="post" action="../contratacion/historial.php">
              ...
              <div class="table-responsive">
                <table>
                  ...
                  <?php
                    ...
                    $consulta="SELECT * FROM persona,contratacion,cargo WHERE persona.IdPersona=contratacion.IdPersona AND cargo.IdCargo=persona.IdCargo AND persona.IdCargo <> 3 AND (persona.NombreP LIKE '%$busqueda%' OR persona.Apellido LIKE '%$busqueda%' OR persona.Documento LIKE '%$busqueda%') ORDER BY contratacion.IdContratacion DESC";
