<?php
  ...
  if (isset($_POST['nuevo'])) {
    $alert='';
    if (empty($_POST['txtNombreC']) || empty($_POST['txtApellidoC'])) {
      ...
      if(!empty($_POST['txtUsuarioC'])){
        ...
        if ($result) {
          ...
          $query_insert=mysqli_query($con,"INSERT INTO persona(IdCargo,NombreP,Apellido,Documento,Telefono,Direccion,Usuario,Estado,TipoCliente) VALUES('3','$nombre','$apellido','$documento','$telefono','$direccion','$usuario1','Activo','$selectTipo' )");

            if ($query_insert) {
              echo "<script>alert('Registro Insertado')</script>";
              echo "<script>window.open('select_adm_cli.php','_self')</script>";
      ...
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          ...
          <div class="row">
            ...
            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
              <form action="../buscador/buscar_usuario.php" method="get" class="form_search">
            ...
            <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
              <div class="mover d-flex justify-content-center">
                ...
                <button class="boton3-ini-nuevo" data-toggle="modal" data-target="#new_cliente"> NUEVO <i class="fas fa-plus"></i> 
                </button>
              ...
              <div class="table-responsive">
                <table>
                  ...
                  <?php
                    ...
                    $consulta="SELECT * FROM persona WHERE IdCargo = 3 ORDER BY IdPersona DESC LIMIT $desde,$por_pagina";
                  ...
                  <tr>
                    ...
                    <?php if($tipoCliente=='Fijo'){ ?>
                      <td><p class="estado1"><?php echo $tipoCliente; ?></p></td>
                    <?php }else if($tipoCliente=='Externo'){ ?>
                      <td><p class="estado2"><?php echo $tipoCliente; ?></p></td>
                    <?php } ?>
                    ...
                    <td><a href="select_adm_cli.php?eliminar=<?php echo $idpersona; ?>"><i class='far fa-trash-alt' style='font-size:24px;color:black;' onclick="return ComfirmDelete()" ></i></a></td>
                  </tr>
                  ...
                  <div class="container-fluid">
                      ...
                      <div class="row py-2">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                          ...
                          <input type="number" id="inputDocumento" class="form-control" placeholder="Documento" name="txtDocumentoC" value="<?php echo $documento; ?>" >
                        </div>
                      ...
                      <div class="row py-2">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                          <?php
                            $buscar=mysqli_query($con,"SELECT TipoCliente FROM persona WHERE IdPersona='$idpersona' ");
                            $result_sql=mysqli_fetch_array($buscar);
                          ?>
                          <select name="txtTipoCliente" class="notItemOne form-control">

                            <?php

                            echo "<option value=".$result_sql['TipoCliente'].">".$result_sql['TipoCliente']."</option>";

                              $sql=mysqli_query($con,"SELECT TipoCliente FROM persona WHERE TipoCliente IS NOT NULL GROUP BY TipoCliente");
                              while ($res=mysqli_fetch_array($sql)) {
                                echo "<option value=".$res['TipoCliente'].">".$res['TipoCliente']."</option>";
                              }
                            ?>
                          </select>
                        </div>
        ...
        <!-- END Modal actualizar -->
              ...
              if (isset($_POST['actualizar'])) {
                ...
                if (empty($_POST['txtNombreC']) || empty($_POST['txtApellidoC']) || empty($_POST['txtTipoCliente'])) {
                  echo "<script>alert('Error')</script>";
                } else {
                  $idp=$_POST['txtid'];
                  $nombre=$_POST['txtNombreC'];
                  ...
                  if ($result>0) {
                    ...
                    $actualizar="UPDATE persona SET NombreP='$nombre', Apellido='$apellido', Documento='$documento', Telefono='$telefono', Direccion='$direccion', Usuario='$usuario', TipoCliente='$tipo_cliente' WHERE IdPersona='$idp' ";
                  ...
                  <form name="form" method="post" action="">
                    <div class="caja-actualizar">
                      ...
                      <div class="row py-2">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                          <label for="inputDocumento" class="sr-only">Documento</label>
                          <input type="number" id="inputDocumento" class="form-control" placeholder="Documento" name="txtDocumentoC">
                        </div>
