<?php
  ...
  if (isset($_POST['nuevo'])) {
    ...
    if (empty($_POST['txtCargo'])) {
      ...
      $sql=mysqli_query($con,"INSERT INTO cargo(NombreC) VALUES('$cargo')");
      if ($sql) {
        echo "<script>alert('Registro Insertado')</script>";
        echo "<script>window.open('select_adm_rol.php','_self')</script>";
      }else{
...
<body class="foto-ini-rol-1">
    ...
    <header id="caja1-rol-titulo">
      ...
      <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
              <div class="mover d-flex justify-content-center">
                <button class="boton3-ini-nuevo" data-toggle="modal" data-target="#new_cargo"> NUEVO <i class="fas fa-plus"></i> </button>
              </div>
            </div>
          </div>
            ...
            <form method="post" action="">
              <div class="table-responsive">
                <table>
                  ...
                  <?php
                    $consulta="SELECT * FROM cargo ORDER BY IdCargo ASC ";
                  ...
                  <tr>
                    ...
                    <td><a class="btn-actualizar" href="#actualizar<?php echo $idcargo; ?>" data-toggle="modal">ACTUALIZAR</a></td>

                    <?php if($idcargo != 1 and $idcargo != 2 and $idcargo != 3 and $idcargo != 4){ ?>

                    <td><a href="select_adm_rol.php?eliminar=<?php echo $idcargo; ?>"><i class='far fa-trash-alt' style='font-size:24px;color:black;' onclick="return ComfirmDelete()" ></i></a></td>
                  <?php } ?>
                  </tr>
        ...
        <!-- Modal actualizar -->
          <div id="actualizar<?php echo $idcargo; ?>"class="modal fade" data-target="#actualizar<?php echo $idcargo; ?>" role="dialog">
            <div class="modal-dialog modal-md">
              <div class="modal-content">
                <div class="modal-header d-flex justify-content-between">
                  <h3 class="modal-title text-center">Actualizar al cargo <b><?php echo $nombre; ?></b></h3>
                  ...
                  <div class="container-fluid">
                      ...
                      <div class="row py-2">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                          <input type="hidden" name="txtid" value="<?php echo $idcargo; ?>">
                        </div>
                      ...
                      <div class="row py-2">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                          ...
                          <input type="text" id="inputName" class="form-control"name="txtNombreR" value="<?php echo $nombre; ?>" required autofocus>
                        </div>
        ...
        <!-- END Modal actualizar -->                  
              ...
              <?php
                if (isset($_POST['actualizar'])) {
                  ...
                  if (empty($_POST['txtNombreR'])) {
                    echo "<script>alert('Error')</script>";
                  } else {

                    $idp_a=$_POST['txtid'];
                    $nombre_a=$_POST['txtNombreR'];

                    $actualizar_a="UPDATE cargo SET NombreC='$nombre_a' WHERE IdCargo='$idp_a'";
                    $ejecutar_a=mysqli_query($con,$actualizar_a);
                    if ($ejecutar_a) {
              ...
              <?php
                if (isset($_GET['eliminar'])) {
                  ...
                  $eliminar="DELETE FROM cargo WHERE IdCargo='$borrar_id'";
                  $ejecutar=mysqli_query($con,$eliminar);
                  if ($ejecutar) {
                    echo "<script>alert('el cargo ha sido eliminado')</script>";
                    echo "<script>window.open('select_adm_rol.php','_self')</script>";
                  }else{
                    echo "<script>alert('Error')</script>";
                  }
      ...
      <!--INICIO MODALES-->
        ...
        <div id="new_cargo" class="modal fade" role="dialog">

          <div class="modal-dialog modal-md">

            <div class="modal-content">
                <div class="modal-header d-flex justify-content-between">
                  <h3 class="modal-title text-center titulo_modal">INSERTAR CARGO</h3>
                  <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                    ...
                    <div class="caja-actualizar">
                      ...
                      <div class="row py-2">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                          ...
                          <input type="text" id="inputCargo" class="form-control" placeholder="Escribir Nuevo Cargo" name="txtCargo" required> 
                        </div>
