      ...
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
            <h1 class="h2">CLIENTES DEUDORES</h1>
          ...
          <div class="row">
            ...
            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
              <div class="mover d-flex justify-content-center">
                <a class="imprimir" href="pdf_deudores.php" target="_blank">IMPRIMIR <i class="icon-printer"></i></a>
              </div>
            </div>
          </div>
              ...
              <div class="table-responsive">
                <table>
                  <tr>
                    ...
                    <td class=" tamaño_fila1"><b>NOMBRES</b></td>
                    <td class=" tamaño_fila1"><b>APELLIDOS</b></td>
                    <td class=" tamaño_fila1"><b>DOCUMENTOS</b></td>
                    <td class=" tamaño_fila1"><b>FECHA</b></td>
                    <td class=" tamaño_fila1"><b>DEUDA</b></td>
                  </tr>

                  <?php

                    $consulta="SELECT p.NombreP AS nombre, p.Apellido AS Apellido, p.Documento AS Documento, pg.Fecha AS fecha, pg.SaldoPendiente AS saldo FROM persona p, pago pg WHERE p.IdPersona=pg.IdCliente AND pg.Estatus=1 AND pg.SaldoPendiente<>0 AND pg.Estado='Debe' ORDER BY pg.Fecha DESC";
                  ...
                  <tr>
                    ...
                    <td class="tamaño_fila"><?php echo $apellido; ?></td>
                    <td class="tamaño_fila"><?php echo $documento; ?></td>
                    <td class="tamaño_fila"><?php echo $fecha; ?></td>
                    <td class="tamaño_fila"><b>$ <?php echo number_format($saldo); ?></b></td>
                  </tr>
                  <?php
                    }
                  ?>
