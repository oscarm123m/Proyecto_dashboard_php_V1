      ...
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          ...
          <div class="espacio_tabla_ventas">
                <table>
                  <tr>
                    <td class=" tamaño_fila1"><b>FAC_N°</b></td>
                    <td class=" tamaño_fila1"><b>FECHA</b></td>
                    <td class=" tamaño_fila1"><b>CLIENTE</b></td>
                    <td class=" tamaño_fila1"><b>VENDEDOR</b></td>
                    <td class=" tamaño_fila1"><b>VALOR TOTAL</b></td>
                    <td class=" tamaño_fila1"><b>VER</b></td>
                  </tr>
                  ...
                  <?php
                      ...
                      $consulta="SELECT v.IdVenta AS cod_venta, (SELECT pr.NombreP FROM persona pr WHERE pr.IdPersona=v.IdPersona) AS cliente, (SELECT pe.Apellido FROM persona pe WHERE pe.IdPersona=v.IdPersona) AS apellido , (SELECT p.NombreP FROM persona p WHERE p.IdPersona=v.IdVendedor) AS vendedor, v.Fecha AS fecha, v.ValorTotal AS valortotal, v.Estado AS estado FROM venta v WHERE Fecha='$fecha_1' AND Estado='Pagada' ORDER BY v.IdVenta DESC";
                  ...
                  <tr>
                    <td class="tamaño_fila"><?php echo $idventa; ?></td>
                    <td class="tamaño_fila"><?php echo $fecha; ?></td>
                    <td class="tamaño_fila"><b><?php echo $nombreC; ?> <?php echo $apellido; ?></b></td>
                    <td class="tamaño_fila"><?php echo $vendedor; ?></td>
                    <td class="tamaño_fila">$ <?php echo number_format($valor); ?></td>

                    <td>

                      <form action="../ventas/pdf_ventas.php" method="post" target="_blank">
                  ...
                  <tr>
                    <td colspan="4" style="text-align: right; font-weight: bold; font-size: 15px;">VALOR TOTAL</td>
