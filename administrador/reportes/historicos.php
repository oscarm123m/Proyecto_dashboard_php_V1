        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          ...
          <div class="row">
            ...
            <?php  
              ...
              $consulta2="SELECT MONTHNAME(Fecha) mes, SUM(ValorTotal) Valor FROM venta WHERE year(Fecha)=year(curdate())-1 AND Estado='Pagada' GROUP BY mes ORDER BY fecha ASC";
              ...
              $consulta3="SELECT MONTHNAME(Fecha) mes, SUM(ValorTotal) Valor FROM venta WHERE year(Fecha)=year(curdate())-2 AND Estado='Pagada' GROUP BY mes ORDER BY fecha ASC";
