<?php
  ...
  if (!empty($_POST)) {
    if (empty($_POST['txtMarca']) || empty($_POST['txtPlaca']) || empty($_POST['txtColor']) || empty($_POST['txtTipo'])) {
      ...
      $sql=mysqli_query($con,"INSERT INTO vehiculo(Marca,Placa,Color,Tipo) VALUES('$marca','$placa','$color','$tipo')");
      if ($sql) {
        echo "<script>alert('Registro Insertado')</script>";
        echo "<script>window.open('select_adm_veh.php','_self')</script>";
      }else{
...
<body class="foto-ini-rol">
    ...
    <header id="caja1-rol-titulo">
                  ...
                  <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
                      <div class="mover d-flex justify-content-center">
                        <button class="boton3-ini-nuevo" data-toggle="modal" data-target="#new_veh"> NUEVO <i class="fas fa-plus"></i> </button>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="table-responsive">
                    <table>
                      <tr>
                        ...
                        <td class="th1"><b>MARCA</b></td>
                        <td class="th1"><b>PLACA</b></td>
                        <td class="th1"><b>COLOR</b></td>
                      ...
                      <?php
                      $sql_registe_v=mysqli_query($con,"SELECT COUNT(*) AS cantidad FROM vehiculo");
                      $result_register_v=mysqli_fetch_array($sql_registe_v);
                      $numero_v=$result_register_v['cantidad'];

                      $por_pagina=10;
                      if (empty($_GET['pagina_v'])) {
                        $pagina_v=1;
                      }else{
                        $pagina_v=$_GET['pagina_v'];
                      }

                      $desde_v=($pagina_v-1)*$por_pagina;
                      $total_pagina_v=ceil($numero_v / $por_pagina);



                        $consulta="SELECT * FROM vehiculo ORDER BY IdVehiculo DESC LIMIT $desde_v,$por_pagina";
                      ...
                      <tr>
                        ...
                        <td><a class="btn-actualizar" href="#actualizar<?php echo $idvehiculo; ?>" data-toggle="modal">ACTUALIZAR</a></td>

                        <td><a href="select_adm_veh.php?eliminar=<?php echo $idvehiculo; ?>"><i class='far fa-trash-alt' style='font-size:24px;color:black;' onclick="return ComfirmDelete()" ></i></a></td>
                      </tr>



          <!-- Modal actualizar -->
          <div id="actualizar<?php echo $idvehiculo; ?>"class="modal fade" data-target="#actualizar<?php echo $idvehiculo; ?>" role="dialog">
            <div class="modal-dialog modal-md">
              <div class="modal-content">
                <div class="modal-header d-flex justify-content-between">
                  <h3 class="modal-title text-center">Actualizar el vehiculo <b><?php echo $marca; ?></b></h3>
                  ...
                  <div class="container-fluid">
                      ...
                      <div class="row py-2">
                        ...
                        <div class="col-xs-12 col-sm-5 col-md-5 col-lg-5">
                          <p class="caja-actualizar-cli">Marca: </p>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                          <label for="inputName" class="sr-only">Marca</label>
                          <input type="text" id="inputName" class="form-control" name="txtMarcaV" value="<?php echo $marca; ?>" required>
                        </div>
                      ...
                      <div class="row py-2">
                        ...
                        <div class="col-xs-12 col-sm-5 col-md-5 col-lg-5">
                          <p class="caja-actualizar-cli">Placa: </p>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                          <label for="inputLastName" class="sr-only">Placa</label>
                          <input type="text" id="inputLastName" class="form-control" name="txtPlacaV" value="<?php echo $placa; ?>" required>
                        </div>
                      ...
                      <div class="row py-2">
                        ...
                        <div class="col-xs-12 col-sm-5 col-md-5 col-lg-5">
                          <p class="caja-actualizar-cli">Color: </p>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                          <label for="inputDocumento" class="sr-only">Color</label>
                          <input type="text" id="inputDocumento" class="form-control" name="txtColorV" value="<?php echo $color; ?>" required>
                        </div>
                      ...
                      <div class="row py-2">
                        ...
                        <div class="col-xs-12 col-sm-5 col-md-5 col-lg-5">
                          <p class="caja-actualizar-cli">Tipo: </p>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                          <label for="inputTelefono" class="sr-only">Tipo</label>
                          <input type="text" id="inputTelefono" class="form-control" name="txtTipoV" value="<?php echo $tipo; ?>">
                        </div>
        ...
        <!-- END Modal actualizar -->
                ...
                <div class="paginador">
                  <ul>
                    ...
                    ?>
                    <li><a href="?pagina_v=<?php echo 1; ?>">|<</a></li>
                    <li><a href="?pagina_v=<?php echo $pagina_v-1; ?>"><<</a></li>
                    <?php 
                      }
                      for ($i=1; $i <= $total_pagina_v; $i++) {
                        if ($i==$pagina_v) {
                           echo '<li class="pageSelected">'.$i.'</li>';
                         } else {
                           echo '<li><a href="?pagina_v='.$i.'">'.$i.'</a></li>';
                         }
                      }
                      if ($pagina_v!=$total_pagina_v) {
                    ?>

                    <li><a href="?pagina_v=<?php echo $pagina_v+1; ?>">>></a></li>
                    <li><a href="?pagina_v=<?php echo $total_pagina_v; ?>">>|</a></li>
                    <?php 
                      }
                    ?>
                  </ul>
                ...
                <!--FIN PAGINADOR-->
                  ...
                  <!--codigo actualizar-->
                    ...
                    <?php
                      if (isset($_POST['actualizar'])) {
                        ...
                        if (empty($_POST['txtMarcaV']) || empty($_POST['txtPlacaV']) || empty($_POST['txtColorV']) || empty($_POST['txtTipoV'])) {
                          echo "<script>alert('Error')</script>";
                        } else {
                          $idp_actualizar=$_POST['txtid'];
                          $marca_actualizar=$_POST['txtMarcaV'];
                          $placa_actualizar=$_POST['txtPlacaV'];
                          $color_actualizar=$_POST['txtColorV'];
                          $tipo_actualizar=$_POST['txtTipoV'];

                          $actualizar_veh="UPDATE vehiculo SET Marca='$marca_actualizar', Placa='$placa_actualizar', Color='$color_actualizar', Tipo='$tipo_actualizar' WHERE IdVehiculo=$idp_actualizar ";
                          $ejecutar_veh=mysqli_query($con,$actualizar_veh);
                  ...
                  <?php
                    if (isset($_GET['eliminar'])) {
                      ...
                      $eliminar="DELETE FROM vehiculo WHERE IdVehiculo='$borrar_id'";
      ...
      <!--INICIO MODALES-->
          ...
          <!--INICIO MODAL INSERTAR VEHICULO-->

        <div id="new_veh" class="modal fade" role="dialog">

          <div class="modal-dialog modal-md">

            <div class="modal-content">
                <div class="modal-header d-flex justify-content-between">
                  <h3 class="modal-title text-center titulo_modal">INSERTAR VEHICULO</h3>
                  <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                    ...
                    <div class="caja-actualizar">
                      ...
                      <div class="row py-2">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                          ...
                          <input type="text" id="inputMarca" class="form-control" name="txtMarca" required>
                        </div>
                      ...
                      <div class="row py-2">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                          ...
                          <input type="text" id="inputPlaca" class="form-control" name="txtPlaca" required>
                        </div>
                      ...
                      <div class="row py-2">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                          ...
                          <input type="text" id="inputColor" class="form-control" name="txtColor" required>
                        </div>
                      ...
                      <div class="row py-2">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                          ...
                          <input type="text" id="inputTipo" class="form-control"  name="txtTipo" required>
                        </div>
