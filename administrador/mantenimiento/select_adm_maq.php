<?php
  ...
  if (!empty($_POST)) {
    if (empty($_POST['txtNombreMaq']) || empty($_POST['txtMarca'])) {
      //$alert='<p class="msg_error">Algunos campos son abligatorios</p>';
    } else {

      include("../../conexiones/conexion.php");

      $nombrem=$_POST['txtNombreMaq'];
      $marca=$_POST['txtMarca'];

      $sql=mysqli_query($con,"INSERT INTO maquinaria(NombreMaq,Marca) VALUES('$nombrem','$marca')");
      if ($sql) {
        echo "<script>alert('Registro Insertado')</script>";
        echo "<script>window.open('select_adm_maq.php','_self')</script>";
      }else{
...
<body class="foto-ini-rol">
    ...
    <header id="caja1-rol-titulo">
                  ...
                  <div class="row ">
                    ...
                    <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
                      <div class="mover d-flex justify-content-center">
                        <button class="boton3-ini-nuevo" data-toggle="modal" data-target="#new_maq"> NUEVO <i class="fas fa-plus"></i> </button>
                      </div>
                    </div>
                  </div>
                ...
                <form method="post" action="">
                  <div class="table-responsive">
                    <table>
                      ...
                      <?php
                      $sql_registe_m=mysqli_query($con,"SELECT COUNT(*) AS cantidad FROM maquinaria");
                      $result_register_m=mysqli_fetch_array($sql_registe_m);
                      $numero_m=$result_register_m['cantidad'];

                      $por_pagina=10;
                      if (empty($_GET['pagina_m'])) {
                        $pagina_m=1;
                      }else{
                        $pagina_m=$_GET['pagina_m'];
                      }

                      $desde_m=($pagina_m-1)*$por_pagina;
                      $total_pagina_m=ceil($numero_m / $por_pagina);


                        $consulta="SELECT * FROM maquinaria ORDER BY IdMaquinaria DESC LIMIT $desde_m,$por_pagina";
                        $ejecutar=mysqli_query($con,$consulta);
                        $i=0;
                        while ($fila=mysqli_fetch_array($ejecutar)) {
                          $idmaquinaria=$fila['IdMaquinaria'];
                          $nombre=$fila['NombreMaq'];
                          $marca=$fila['Marca'];
                          $i++;
                          $in=$i+$desde_m;
                      ?>
                      ...
                      <tr>
                        ...
                        <td><a class="btn-actualizar" href="#actualizar<?php echo $idmaquinaria; ?>" data-toggle="modal">ACTUALIZAR</a></td>

                        <td><a href="select_adm_maq.php?eliminar=<?php echo $idmaquinaria; ?>"><i class='far fa-trash-alt' style='font-size:24px;color:black;' onclick="return ComfirmDelete()" ></i></a></td>

                      </tr>


          <!-- Modal actualizar -->
          <div id="actualizar<?php echo $idmaquinaria; ?>"class="modal fade" data-target="#actualizar<?php echo $idmaquinaria; ?>" role="dialog">
            <div class="modal-dialog modal-md">
              <div class="modal-content">
                <div class="modal-header d-flex justify-content-between">
                  <h3 class="modal-title text-center">Actualizar al <b><?php echo $nombre; ?></b></h3>
                  ...
                  <div class="container-fluid">
                      ...
                      <div class="row py-2">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                          <input type="hidden" name="txtid" value="<?php echo $idmaquinaria; ?>">
                        </div>
                      ...
                      <div class="row py-2">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                          ...
                          <input type="text" id="inputName" class="form-control" name="txtNombreM" value="<?php echo $nombre; ?>" required>
                        </div>
                      ...
                      <div class="row py-2">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                          <label for="inputLastName" class="sr-only">Marca</label>
                          <input type="text" id="inputLastName" class="form-control" name="txtMarcaM" value="<?php echo $marca; ?>" required>
                        </div>
        ...
        <!-- END Modal actualizar -->
                ...
                <div class="paginador">
                  <ul>
                    ...
                    ?>
                    <li><a href="?pagina_m=<?php echo 1; ?>">|<</a></li>
                    <li><a href="?pagina_m=<?php echo $pagina_m-1; ?>"><<</a></li>
                    <?php 
                      }
                      for ($i=1; $i <= $total_pagina_m; $i++) {
                        if ($i==$pagina_m) {
                           echo '<li class="pageSelected">'.$i.'</li>';
                         } else {
                           echo '<li><a href="?pagina_m='.$i.'">'.$i.'</a></li>';
                         }
                      }
                      if ($pagina_m!=$total_pagina_m) {
                    ?>

                    <li><a href="?pagina_m=<?php echo $pagina_m+1; ?>">>></a></li>
                    <li><a href="?pagina_m=<?php echo $total_pagina_m; ?>">>|</a></li>
                    <?php 
                      }
                    ?>
                  </ul>
            ...
            <!--codigo actualizar-->
              ...
              <?php
                if (isset($_POST['actualizar'])) {
                  ...
                  if (empty($_POST['txtNombreM']) || empty($_POST['txtMarcaM'])) {
                    echo "<script>alert('Error')</script>";
                  } else {
                    
                    $idp_actualizar=$_POST['txtid'];
                    $nombre_actualizar=$_POST['txtNombreM'];
                    $marca_actualizar=$_POST['txtMarcaM'];

                    $actualizar_maq="UPDATE maquinaria SET NombreMaq='$nombre_actualizar', Marca='$marca_actualizar' WHERE IdMaquinaria=$idp_actualizar ";
                    $ejecutar_maq=mysqli_query($con,$actualizar_maq);
            ...
            <!--fin codigo actualizar-->
                  ...
                  <?php
                    if (isset($_GET['eliminar'])) {
                      ...
                      $eliminar="DELETE FROM maquinaria WHERE IdMaquinaria='$borrar_id'";
      ...
      <!--INICIO MODALES-->
        ...
        <div id="new_maq" class="modal fade" role="dialog">

          <div class="modal-dialog modal-md">

            <div class="modal-content">
                <div class="modal-header d-flex justify-content-between">
                  <h3 class="modal-title text-center titulo_modal">INSERTAR MAQUINARIA</h3>
                  <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                  ...
                  <form name="form" method="post" action="">
                    <div class="caja-actualizar">
                      ...
                      <div class="row py-2">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                          <label for="inputName" class="sr-only">Nombre</label>
                          <input type="text" id="inputName" class="form-control" placeholder="Nombre" name="txtNombreMaq" required>
                        </div>
                      ...
                      <div class="row py-2">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                          ...
                          <input type="text" id="inputMarca" class="form-control" placeholder="Marca" name="txtMarca" required>
                        </div>
