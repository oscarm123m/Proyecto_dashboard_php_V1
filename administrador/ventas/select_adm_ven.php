      ...
      <!--CONSULTA 4-->
              <div class="table-responsive">
                <table>
                  ...
                  <?php
                    $sql_registe=mysqli_query($con,"SELECT COUNT(*) AS cantidad FROM venta");
                    ...
                    $consulta="SELECT v.IdVenta AS cod_venta, (SELECT pr.NombreP FROM persona pr WHERE pr.IdPersona=v.IdPersona) AS cliente, (SELECT pe.Apellido FROM persona pe WHERE pe.IdPersona=v.IdPersona) AS apellido ,(SELECT persona.Documento FROM persona WHERE persona.IdPersona=v.IdPersona) AS documento,(SELECT persona.TipoCliente FROM persona WHERE persona.IdPersona=v.IdPersona) AS tipo_cliente, (SELECT p.NombreP FROM persona p WHERE p.IdPersona=v.IdVendedor) AS vendedor, v.Fecha AS fecha, v.ValorTotal AS valortotal, v.Estado AS estado FROM venta v ORDER BY v.IdVenta DESC LIMIT $desde,$por_pagina";
                  ...
                  <div class="container-fluid">
                      ...
                      <div class="modal-footer">
                        ...
                        <div class="row">
                          ...
                          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <input class="boton-insertar-anular" type="submit" name="eliminar" value="Anular">
