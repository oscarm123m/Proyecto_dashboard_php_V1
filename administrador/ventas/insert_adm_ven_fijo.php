      ...
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
            <h1 class="h2">VENTAS CLIENTE FIJO</h1>
          ...
          <div class="row">
            ...
            <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
              <div class="mover d-flex justify-content-center">
                ...
                <form class="mover d-flex justify-content-end" action="insert_adm_ven.php">
                  <button class="boton-insertar2-tipo-egreso" type="submit" name="EXTERNO" >
                    EXTERNO <i class="fas fa-shopping-cart" ></i>
                  </button>
                </form>
          ...
          <div class="container">
            ...
            <div class="row py-2">
              ...
              <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                <a href="../clientes/select_adm_cli.php" class="estilos_boton_new_cli btn_new"><i class="fas fa-plus"></i>Nuevo cliente</a>
              </div>
            </div>
                ...
                <div class="col-xs-12 col-sm-5 col-md-5 col-lg-5">
                  ...
                  <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <select id="select_cliente" name="selectTipo_cliente" style="width: 170px;" class="form-control">
              ...
              <div class="row py-2">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                  ...
                  <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                      <input type="text" id="doc_cliente" class="form-control" name="doc_cliente" disabled >
                    </div>
              ...
              <div class="row py-2">
                ...
                <div class="col-xs-12 col-sm-5 col-md-5 col-lg-5">
                  ...
                  <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                      <input type="text" id="tel_cliente" class="form-control" name="tel_cliente" disabled required>
                    </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                  ...
                  <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                      <input type="text" id="dir_cliente" class="form-control" name="dir_cliente" disabled >
                    </div>
