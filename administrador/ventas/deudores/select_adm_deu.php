          ...
          <div>
              <div class="table-responsive">
                <table>
                  ...
                  <?php
                    $consulta="SELECT pg.IdPago AS IdPago, pg.IdCliente AS IdCli, p.NombreP AS Nombre_Cliente, p.Apellido AS Apellido_Cliente, p.Documento AS Documento, pg.Fecha AS Fecha, pg.SaldoPendiente AS Saldo FROM persona p, pago pg WHERE p.IdPersona=pg.IdCliente AND pg.SaldoPendiente<>0 AND pg.Estatus=1 AND pg.Estado='Debe' ORDER BY pg.IdPago DESC";
                  ...
                  <tr>
                    ...
                    <td><a class="btn-actualizar_1" href="#actualizar<?php echo $idpago; ?>" data-toggle="modal">ABONAR</a></td>

                    <td><a href="select_adm_deu.php?eliminar=<?php echo $idpago; ?>"><i class='fas fa-trash-alt' style='font-size:24px;color:black;' onclick="return ComfirmDelete()" ></i></a></td>
                  </tr>



          <!-- Modal actualizar -->
          <div id="actualizar<?php echo $idpago; ?>"class="modal fade" data-target="#actualizar<?php echo $idpago; ?>" role="dialog">
            <div class="modal-dialog modal-md">
              <div class="modal-content">
                <div class="modal-header d-flex justify-content-between">
                  <h3 class="modal-title text-center">El cliente <?php echo $nombrecliente; ?> abona?</h3>
                  ...
                  <div class="container-fluid">
                      ...
                      <div class="row py-2">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                          <input type="hidden" name="txtid" value="<?php echo $idpago; ?>">
                        </div>
        ...
        <!-- END Modal actualizar -->
              ...
              <?php
                if (isset($_POST['actualizar'])) {
                  ...
                  if (empty($_POST['txtFecha']) || empty($_POST['txtSaldo'])) {
                    ...
                    $query=mysqli_query($con,"SELECT * FROM pago WHERE IdPago='$idp'");
                    $result=mysqli_fetch_array($query);
                    $saldo_pagar=$result['SaldoPagar'];
                    $saldo_p=$result['SaldoPendiente'];
                    $valor_f=$result['ValorFactura'];
                    ...
                    if ($saldo>$saldo_p) {
                      ...
                      $actualizar_1="INSERT INTO pago(IdCliente,Fecha,SaldoPagar,ValorFactura,Estatus,SaldoPendiente,Estado) VALUES('$id_cliente','$fecha_p','$saldo','$valor_f','1','$saldo_pend_total','$estado')";
                      $ejecutar_1=mysqli_query($con,$actualizar_1);

                      $actualizar="UPDATE pago SET Estado='En Proceso' WHERE IdPago=$idp ";
                      $ejecutar=mysqli_query($con,$actualizar);

                      if ($ejecutar_1 && $ejecutar) {
                        echo "<script>alert('Registro Actualizado')</script>";
                        echo "<script>window.open('select_adm_deu.php','_self')</script>";
                      }else{
                        echo "<script>alert('Error')</script>";
                      }
                    }
              ...
              <?php
                if (isset($_GET['eliminar'])) {
                  ...
                  $eliminar="UPDATE pago SET Estatus=2, Estado='Cancelado' WHERE IdPago='$borrar_id'";
          ...
          <div class="modal-dialog modal-md">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <form name="form_new_deuda" id="form_new_deuda" method="post">
                    <div class="caja-actualizar">
                      
                      <div class="row py-2">

                        <div class="col-xs-12 col-sm-5 col-md-5 col-lg-5">
                          <p class="caja-actualizar-cli">Cliente: </p>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">

                          <select id="select_cliente" style="width: 200px;" name="selectdeudores">
                            <option value="0">Seleccione un cargo</option>
                            
                            <?php
                              $sql=mysqli_query($con,"select * from persona where IdCargo=3 and TipoCliente='Fijo'");
                          ...
                          <input type="hidden" name="action" value="addClienteDoc">

                          <input type="hidden" id="idCliente_fijo" name="idCliente_fijo" value="" required>
