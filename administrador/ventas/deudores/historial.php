          ...
          ?>
              ...
              <div class="table-responsive">
                <table>
                  ...
                  <?php
                    $sql_registe=mysqli_query($con,"SELECT COUNT(*) AS cantidad FROM pago WHERE IdCliente='$busqueda'");
            ...
            <div class="table-responsive">
                <table>
                  ...
                  <?php
                    $sql_registe=mysqli_query($con,"SELECT COUNT(*) AS cantidad FROM pago");
                    $result_register=mysqli_fetch_array($sql_registe);
                    $numero=$result_register['cantidad'];
                    ...
                    $consulta="SELECT pg.IdPago AS IdPago, p.NombreP AS Nombre_Cliente, p.Apellido AS Apellido_Cliente, p.Documento AS Documento, pg.Fecha AS Fecha, pg.SaldoPagar AS Saldo_pagar, pg.SaldoPendiente AS saldo_pendiente, pg.ValorFactura AS factura, pg.Estado as estado FROM persona p, pago pg WHERE p.IdPersona=pg.IdCliente ORDER BY pg.IdPago DESC LIMIT $desde,$por_pagina";
                    $ejecutar=mysqli_query($con,$consulta);
                    $i=0;
                    while ($fila=mysqli_fetch_array($ejecutar)) {
                      $idpago=$fila['IdPago'];
